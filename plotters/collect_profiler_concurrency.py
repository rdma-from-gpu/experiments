...
if __name__ == "__main__":
        ...
        if args.force or new_data(t):
            ...
            try:
                generate_h5(t, args.time_precision,
                            {"CONCURRENCY":"--profile-concurrency", "MODEL": "--model", "MODEL": "--workload"})
    ...
    keys = set()
    for f in h5s:
        r, kr, times = read_h5(f, times=True)
        if r is None:
    ...
    all_r, all_kr, all_times =  join_results(all_r, all_kr, all_times)
