...
set -x
TESTNAME="generator_pktsize_cpu"
...
ansible-playbook -i ./inventory/a100.yml ./generator_pktsize.yml  --extra-vars='{"MODES":["crafted", "standard"], "BATCH":512, "GPU_BATCH":1}' $@
...
cd plotters
python3 collect_generator_pktsize.py --path ../results/generator_pktsize_cpu
